...
public class news_sports_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_news_sports_fragment, null);

        arrayList = new ArrayList<>();
        recyclerViewSports = v.findViewById(R.id.newsRecyclerViewSports);
        ...
        recyclerViewSports.setAdapter(recyclerViewAdapter);
