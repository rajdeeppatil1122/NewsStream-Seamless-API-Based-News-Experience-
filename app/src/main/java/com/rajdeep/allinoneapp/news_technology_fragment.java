...
public class news_technology_fragment extends Fragment {
    ...
    public news_technology_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_news_technology_fragment, null);

        arrayList = new ArrayList<>();
        recyclerViewTechnology = v.findViewById(R.id.newsRecyclerViewTechnology);
        ...
        recyclerViewTechnology.setAdapter(recyclerViewAdapter);
