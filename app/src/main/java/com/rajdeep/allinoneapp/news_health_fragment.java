...
public class news_health_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_news_health_fragment, null);

        arrayList = new ArrayList<>();
        recyclerViewHealth = v.findViewById(R.id.newsRecyclerViewHealth);
        ...
        recyclerViewHealth.setAdapter(recyclerViewAdapter);
